...
app.get("/closer", async (req, res) => {
  ...
  const L = en ? {
    ...
    script: [
      ...
      ["02 · Who we are", "“Before I show you anything: Quick Comp was born inside Alto Realty Group, a real estate company in South Texas that was tired of comping all the time. They built these tools to solve that — and they worked so well they opened them to the public. We're not an agency reselling software; we run our own deals on this.”"],
      ...
      ["06 · Your widget", "“This is your widget — the same home-value tool. It goes two places: as a link in your Instagram bio, Facebook and WhatsApp, AND embedded right on your website. (tap the link on the phone) Every homeowner who wonders what their house is worth taps it — and their name and number land in your app.”"],
    ...
    script: [
      ...
      ["02 · Quiénes somos", "“Antes de enseñarte nada: Quick Comp nació dentro de Alto Realty Group, una compañía de bienes raíces del sur de Texas que estaba cansada de sacar comparables a cada rato. Hicieron estas herramientas para resolverlo — y funcionaron tan bien que las abrieron al público. No somos una agencia revendiendo software; nuestros propios cierres corren con esto.”"],
      ...
      ["06 · Tu valuador", "“Este es tu valuador — la misma herramienta de valor. Va en dos lados: como link en tu bio de Instagram, Facebook y WhatsApp, Y metido directo en tu página web. (toca el link en el teléfono) Cada dueño que se pregunta cuánto vale su casa lo toca — y su nombre y teléfono llegan a tu app.”"],
...
app.get("/demo", (req, res) => {
  ...
  const L = en ? {
    ...
    t1: "Welcome", t2: "Who we are", t3: "The problem", t4: "Your website", t5: "Your app", t6: "Your AI secretary", t7: "Your investment", t8: "Let's begin", ts: "Your widget",
    ...
    b2: "Quick Comp was born inside Alto Realty Group, a real estate company in South Texas that was tired of comping all the time. We built these tools to get an accurate number in seconds instead of an afternoon of research. They worked so well we opened them to the public, and Alto Realty Group still runs on this exact system every day.",
    ...
    ks: "06 · YOUR WIDGET", hsa: "Your widget,", hsb: "on social and your site.",
    bs: "The same home-value tool lives at your own link AND embeds right on your website — put the link in your Instagram bio, your Facebook page, your WhatsApp status, or drop the widget into your site. Every homeowner who wonders what their house is worth taps it, and becomes a seller lead in your app.",
    psa: "On your social pages — Instagram, Facebook, WhatsApp — AND embedded on your website", psb: "The homeowner taps, types their address and sees their number in seconds", psc: "Their name and phone land in your app — with WhatsApp ready", psd: "Every post you publish now has a job: bringing you listings",
    ...
    t1: "Bienvenida", t2: "Quiénes somos", t3: "El problema", t4: "Tu página", t5: "Tu app", t6: "Tu secretaria IA", t7: "Tu inversión", t8: "Empecemos", ts: "Tu valuador",
    ...
    b2: "Quick Comp nació dentro de Alto Realty Group, una compañía de bienes raíces del sur de Texas que estaba cansada de sacar comparables a cada rato. Construimos estas herramientas para tener un número correcto en segundos en vez de una tarde de investigación. Funcionaron tan bien que las abrimos al público, y Alto Realty Group sigue trabajando con este mismo sistema todos los días.",
    ...
    ks: "06 · TU VALUADOR", hsa: "Tu valuador,", hsb: "en tus redes y tu sitio.",
    bs: "El mismo valuador vive en tu propio link Y se instala directo en tu página web — pon el link en tu bio de Instagram, tu página de Facebook, tu estado de WhatsApp, o mete el valuador en tu sitio. Cada dueño que se pregunta cuánto vale su casa lo toca, y se vuelve un seller lead en tu app.",
    psa: "En tus redes — Instagram, Facebook, WhatsApp — Y dentro de tu página web", psb: "El dueño lo toca, pone su dirección y ve su número en segundos", psc: "Su nombre y teléfono llegan a tu app — con WhatsApp listo", psd: "Cada post que publicas ahora tiene un trabajo: traerte listings",
